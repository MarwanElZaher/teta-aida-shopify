            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div>
                ...
                <ul className="flex flex-col gap-3 text-sm">
                  <li>
                    <NavLink to={`${locale.pathPrefix}/collections/bundles`} className="hover:text-secondary transition-colors">
                      {t('nav.bundles')}
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to={`${locale.pathPrefix}/collections/all`} className="hover:text-secondary transition-colors">
                      {t('nav.allProducts')}
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to={`${locale.pathPrefix}/products/tuffaahy-olives-signature-mix`} className="hover:text-secondary transition-colors">
                      Tuffaahy Olives
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to={`${locale.pathPrefix}/products/low-salt-cucumbers-with-celery`} className="hover:text-secondary transition-colors">
                      Low-Salt Cucumbers
                    </NavLink>
                  </li>
                </ul>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="text-xs uppercase tracking-widest opacity-70">{t('footer.joinCommunity')}</p>
