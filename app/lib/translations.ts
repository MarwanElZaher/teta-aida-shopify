    ...
    AR: {
      ...
      `
        ...
        product: {
            ...
            reviews: 'التقييمات',
            whyLoveIt: 'ليه هتحبه',
            whyBoxWorks: 'ليه الصندوق ده مثالي؟',
            completeExperience: 'كمّل التجربة',
            ...
            loadingConfig: 'جاري تحميل الخيارات...',
            microTrust: {
                freshWeekly: 'طازة أسبوعيًا',
                cleanIngredients: 'مكوّنات نظيفة',
                smallBatch: 'تحضير بكميات صغيرة',
                naturalColor: 'لون طبيعي',
                seasonal: 'تشكيلة العرض الموسمي',
            },
            olives: {
            ...
            winterBox: {
                title: 'صندوق الشتاء الدافئ',
                tagline: 'خفيف، مقرمش، ومريح — ثنائي المخلل الشتوي الموسمي',
                included: 'المحتويات',
                turnips: 'لفت (فينتاج) — لون بنجر طبيعي',
                cucumbers: 'خيار قليل الملح بالكرفس',
                description: 'تشكيلة شتوية متوازنة تضم مخلل اللفت (فينتاج) الجديد والخيار قليل الملح — محضر يدويًا بكميات صغيرة بمكونات طبيعية ونظيفة.',
                why: {
                    title: 'ليه هتحبّوها؟',
                    1: 'مزيج مثالي من الدفء والنكهة الغنية',
                    2: 'مثالية لتدفئة الأجواء في الشتاء',
                    3: 'نكهات تقليدية بلمسة عصرية',
                    4: 'مكونات طبيعية 100% تمنحك شعورًا بالراحة',
                    5: 'جودة حرفية تضمن لك تجربة لا تُنسى',
                    6: 'طعم بيتي يرجعك لأيام زمان',
                },
                uses: {
                    title: 'إزاي تستمتعوا بيها؟',
                    1: 'مع الأطباق الشتوية الدسمة',
                    2: 'كمقبلات دافئة قبل الوجبات',
                    3: 'إضافة مميزة للسندويتشات الساخنة',
                    4: 'مع شوربة العدس أو أي شوربة مفضلة',
                    5: 'كوجبة خفيفة ومغذية في المساء',
                    6: 'هدية شتوية مميّزة',
                },
                reviews: {
                    title: 'آراء العملاء',
                    1: 'أحلى حاجة في الشتا… بتدفي القلب!',
                    2: 'الليمون بالهريسة مع اللفت… مزيج رائع.',
                    3: 'طعمه فريش وبيفرق في السفرة.',
                },
                microTrust: {
                    naturalColor: 'لون طبيعي',
            ...
            lemons: {
                ...
                description: 'ليمون فاخر متقسم أنصاف ومتتبّل بخلطة الهريسة وحبّة البركة. مزيج حار أو خفيف، غني ومثالي للطبخ، التتبيل، وتقديمات الضيافة الفاخرة.',
                inside: {
                    title: 'المكوّنات',
                    1: 'ليمون فاخر',
                    2: 'خلطة هريسة خاصة',
            ...
            turnips: {
                name: 'لفت (فينتاج) — لون بنجر طبيعي',
                tagline: 'مقرمش… تتبيلة خفيفة… وطعم الذكريات.',
                description: 'مخلل لفت مقرمش متقطع يدويًا ومخلل مع بنجر طبيعي عشان ياخد اللون الأحمر الزاهي. تتبيلة خفيفة، حموضة منعشة، وطعم بيتي يرجعك لأيام زمان — بس بلمسة تيتا عايدة الحرفية.',
                microTrust: {
                    naturalColor: 'لون طبيعي',
                    clean: 'مكوّنات نظيفة',
                    smallBatch: 'تحضير بكميات صغيرة',
                ...
                benefits: {
                    title: 'فوائد المنتج',
                    1: 'لون طبيعي من البنجر (بدون ألوان صناعية)',
                    2: 'محلول ملحي متوازن وخفيف',
                    3: 'تتبيلة هادية تناسب كل الأذواق',
                    4: 'قوام مقرمش ومنعش',
                    5: 'مكوّنات نظيفة 100%',
                    6: 'تحضير يدوي بكميات صغيرة',
                    7: 'طعم مألوف ومريح… بس أشيك',
                },
                flavorProfile: {
                    title: 'بروفايل النكهة',
                    texture: 'شرائح متماسكة ومقرمشة',
                    taste: 'حموضة خفيفة، تتبيلة هادية، وملح مظبوط',
                    aroma: 'رائحة ترابية منعشة من البنجر',
                    color: 'لون قرمزي طبيعي يخطف العين',
                },
                usage: {
                    title: 'أفكار للتقديم',
                    1: 'سفرة المقبّلات والعزومات',
                    2: 'الوجبات اليومية',
                    3: 'السندوتشات والراب',
                    4: 'المشويات',
                    5: 'الأكلات الشتوية (عدس، فول، نبت)',
                    6: 'أطباق السلطة',
                },
                reviews: {
                    title: 'آراء العملاء',
                    1: 'أخيراً… لفت طعمه نظيف ومخدوم.',
                    2: 'لونه يجنن على السفرة. وبقى اختياري المفضل.',
                    3: 'طعمه زي مخلل البيت، بس أحلى وأنظف.',
                },
                addToCart: 'أضف الصندوق للسلة',
            },
        },
        ...
        faq: {
            ...
            products: {
                ...
                heat_levels: {
                    q: 'هل في اختيارات لدرجة الشطة؟',
                    a: "أيوه — كل منتج ليه درجات حرارة مختلفة:\n• زيتون تفّاحي: خفيفة / عادي / حار\n• الخيار: خفيفة / عادي\n• الكرنب باليوسفي: خفيفة / عادي\n• الليمون بالهريسة: خفيفة / حار",
                },
                preservatives: {
